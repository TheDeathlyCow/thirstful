...
public final class TBiomeTags {
    ...
    public static final TagKey<Biome> HAS_VERY_UNSAFE_WATER = key("has_very_unsafe_water");
    public static final TagKey<Biome> HAS_VERY_DIRTY_WATER = key("has_very_dirty_water");
